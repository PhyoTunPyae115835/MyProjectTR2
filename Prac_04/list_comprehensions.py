...
numbers = [int(num_str) for num_str in almost_numbers]
print(numbers)

# list comprehension to create a list of only the numbers greater than 9
numbers_above_9 = [num for num in numbers if num > 9]
print(numbers_above_9)

# create a string of last names for those full names longer than 11 characters
long_last_names_string = ", ".join([name.split()[1] for name in full_names if len(name) > 11])
